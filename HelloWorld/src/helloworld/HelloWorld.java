...
//        System.out.println("This program prints a quote from the Gettysburg Address .");
//        System.out.println("Four score and seven years ago , our 'fore fathers ' brought forth on this continent a new nation.");
//        System.out.println("A \"quoted\" String is 'much' better if you learn the rules of \"escape sequences.\" ");
//        System.out.println("Also , \"\" represents an empty String . \t Don' forger: use \\\"instead of\" ! \t '' is not the same as");
